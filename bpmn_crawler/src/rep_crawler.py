...
class RepCrawler:
    ...
    RESET_TIME = 0
    REQUEST_COUNTER = 0
    URL_LIMIT = 'https://api.github.com/rate_limit?client_id=ecde69e021a6a9361e5d&client_secret=0a07515f3d78268c89dea9d25baad5c195216945'
    ...
    def set_limit(self):
        ...
        try:
            ...
            print(message)
            print("Exception! Will wait: " + str(to_wait) + " min")
            time.sleep(to_wait + 60)
            self.set_limit()
        except:
            print("Exception! get_limit() has another type of Error")
            time.sleep(to_wait + 60)
            self.set_limit()
